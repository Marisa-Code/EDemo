...
namespace EdgeShimmer.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        private const string DataTablePath = "Assets/DataTables";
        private const string CSharpCodePath = "Assets/GameMain/Scripts/Game/DataTable";
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "EdgeShimmer");
